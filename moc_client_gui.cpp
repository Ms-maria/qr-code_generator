...
QT_MOC_LITERAL(5, 47, 5) // "error"
    ...
    "ClientThread\0resultReady\0\0result\0"
...
void ClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->resultReady((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ClientThread::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientThread::resultReady)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientThread::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClientThread::resultReady(const QByteArray & _t1)
{
...
// SIGNAL 1
void ClientThread::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
QT_MOC_LITERAL(1, 10, 14), // "generateTextQR"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "generateGeoQR"
QT_MOC_LITERAL(4, 40, 16), // "handleQRResponse"
QT_MOC_LITERAL(5, 57, 8), // "response"
QT_MOC_LITERAL(6, 66, 11), // "handleError"
QT_MOC_LITERAL(7, 78, 5) // "error"

    },
    "ClientGUI\0generateTextQR\0\0generateGeoQR\0"
    "handleQRResponse\0response\0handleError\0"
    "error"
};
#undef QT_MOC_LITERAL
...
void ClientGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->generateTextQR(); break;
        case 1: _t->generateGeoQR(); break;
        case 2: _t->handleQRResponse((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
